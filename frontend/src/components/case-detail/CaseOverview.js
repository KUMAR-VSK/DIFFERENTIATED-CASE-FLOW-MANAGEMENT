    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
                {/* Basic Information */}
                <div className="bg-surface-50 dark:bg-surface-700/30 rounded-lg p-6 transition-colors duration-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Case Number</label>
                                <p className="text-lg font-semibold text-surface-900 dark:text-white font-mono">{caseData.caseNumber}</p>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-1">Case Type</label>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium text-surface-600 dark:text-surface-300 mb-1">Status</label>
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Case Title</label>
                            <p className="text-xl font-semibold text-surface-900 dark:text-white">{caseData.title}</p>
                        </div>
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Description</label>
                            <p className="text-surface-700 dark:text-surface-300 leading-relaxed bg-white dark:bg-surface-800 p-4 rounded-md border dark:border-surface-600 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    <div className="bg-primary-50 dark:bg-blue-900/20 rounded-lg p-4 text-center transition-colors duration-300">
                        <div className="text-2xl font-bold text-primary-600 dark:text-blue-400">{caseData.priority}/10</div>
                        <div className="text-sm text-primary-600 dark:text-blue-300">Priority Level</div>
                    </div>
                ...
                {(caseData.assignedJudge || caseData.filingClerk || caseData.assignedAdvocate) && (
                    <div className="bg-white dark:bg-surface-800 rounded-lg p-6 border border-surface-200 dark:border-surface-700 transition-colors duration-300">
                        <h3 className="text-lg font-semibold text-surface-900 dark:text-white mb-6 flex items-center">
                            <svg className="h-5 w-5 text-surface-600 dark:text-surface-400 mr-2" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {caseData.filingClerk && (
                                <div className="bg-surface-50 dark:bg-surface-700/50 rounded-lg p-4 border-l-4 border-surface-400 dark:border-surface-500">
                                    <div className="flex items-center">
                                        <div className="bg-surface-400 dark:bg-surface-600 rounded-full p-2 mr-3">
                                            <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                                            </svg>
                                        </div>
                                        <div>
                                            <h4 className="text-sm font-medium text-surface-500 dark:text-surface-400">Filing Clerk</h4>
                                            <p className="text-lg font-semibold text-surface-900 dark:text-white">
                                                {caseData.filingClerk.firstName} {caseData.filingClerk.lastName}
                                            </p>
                                            <p className="text-sm text-surface-600 dark:text-surface-300">@{caseData.filingClerk.username}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            {caseData.assignedJudge && (
                                <div className="bg-primary-50 dark:bg-blue-900/20 rounded-lg p-4 border-l-4 border-blue-400 dark:border-blue-500">
                                    <div className="flex items-center">
                                        <div className="bg-primary-500 dark:bg-primary-600 rounded-full p-2 mr-3">
                                            <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                            </svg>
                                        </div>
                                        <div>
                                            <h4 className="text-sm font-medium text-primary-600 dark:text-blue-400">Assigned Judge</h4>
                                            <p className="text-lg font-semibold text-surface-900 dark:text-white">
                                                {caseData.assignedJudge.firstName} {caseData.assignedJudge.lastName}
                                            </p>
                                            <p className="text-sm text-surface-600 dark:text-surface-300">@{caseData.assignedJudge.username}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                                ...
                                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border-l-4 border-purple-400 dark:border-purple-500">
                                    <div className="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-surface-600 dark:text-surface-300">@{caseData.assignedAdvocate.username}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
            ...
            <div className="space-y-6">
                {/* Status & Priority */}
                <div className="bg-white dark:bg-surface-800 rounded-lg shadow-lg p-6 border border-surface-200 dark:border-surface-700 transition-colors duration-300">
                    <h2 className="text-xl font-semibold text-surface-900 dark:text-white mb-6">Status & Priority</h2>
                    <div className="space-y-4">
                        <div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Priority Level</label>
                        ...
                        {caseData.resourceRequirement && (
                            <div>
                                <label className="block text-sm font-medium text-surface-700 mb-2">Resource Requirements</label>
                                <p className="text-sm text-surface-600 bg-surface-50 p-3 rounded-md">
                                    {caseData.resourceRequirement}
                                </p>
                            </div>
                        )}
                ...
                {/* Timeline */}
                <div className="bg-white rounded-lg shadow-lg p-6 border border-surface-200">
                    <h2 className="text-xl font-semibold text-surface-900 mb-6">Timeline</h2>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 bg-surface-50 rounded-md">
                            <span className="text-sm font-medium text-surface-700">Filing Date</span>
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-lg shadow-lg p-6 border-2 border-indigo-200">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full bg-surface-800 dark:bg-surface-300 text-white dark:text-surface-900 px-4 py-3 rounded-lg hover:bg-surface-900 dark:hover:bg-surface-200 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 text-sm font-medium flex items-center justify-center shadow-md mb-2"
                        >
                        ...
                        {(user.role === 'ADMIN' || user.role === 'JUDGE') ? (
                            ...
                            <div className="w-full bg-surface-100 dark:bg-surface-700 text-surface-400 dark:text-surface-500 px-4 py-3 rounded-lg text-sm font-medium flex items-center justify-center border-2 border-dashed border-surface-300 dark:border-surface-600">
                                <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {(user.role === 'ADMIN' || user.role === 'JUDGE') ? (
                            <button
                                ...
                                className="w-full bg-primary-600 text-white px-4 py-3 rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 text-sm font-medium flex items-center justify-center shadow-md"
                            >
                                <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        {user.role === 'JUDGE' && (
                            <div className="border border-primary-200 dark:border-blue-800 rounded-lg p-3 bg-primary-50 dark:bg-blue-900/10">
                                ...
                                {caseData.assignedJudge ? (
                                    ...
                                    <p className="text-xs text-primary-600 dark:text-blue-400 mb-2">No judge assigned yet.</p>
                                )}
                                ...
                                {(!caseData.assignedJudge || caseData.assignedJudge.id !== user.id) && (
                                    <button
                                        ...
                                        disabled={actionLoading}
                                        className="w-full bg-primary-600 hover:bg-primary-700 text-white text-xs font-semibold py-1.5 px-3 rounded shadow-sm flex items-center justify-center transition-colors disabled:opacity-50"
                                    >
                                        Take Over Case
                                    </button>
                                )}
                        ...
                        {user.role === 'ADMIN' && (
                            <div className="border border-primary-200 dark:border-blue-800 rounded-lg p-3 bg-primary-50 dark:bg-blue-900/10">
                                ...
                                <select
                                    className="w-full text-xs px-2 py-1.5 border border-blue-300 dark:border-blue-700 rounded-md bg-white dark:bg-surface-800 text-surface-700 dark:text-surface-300 focus:ring-1 focus:ring-blue-500"
                                    defaultValue=""
                        ...
                        {user.role === 'ADMIN' && (
                            <div className="border border-purple-200 dark:border-purple-800 rounded-lg p-3 bg-purple-50 dark:bg-purple-900/10">
                                ...
                                <select
                                    className="w-full text-xs px-2 py-1.5 border border-purple-300 dark:border-purple-700 rounded-md bg-white dark:bg-surface-800 text-surface-700 dark:text-surface-300 focus:ring-1 focus:ring-purple-500"
                                    defaultValue=""
