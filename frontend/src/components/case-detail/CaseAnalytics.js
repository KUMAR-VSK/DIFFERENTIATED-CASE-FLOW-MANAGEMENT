...
const CaseAnalytics = ({
    ...
    return (
        <div className="bg-white dark:bg-surface-900 rounded-xl">
            <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="bg-primary-600 text-white px-5 py-2 rounded-lg hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium text-sm flex items-center shadow-sm"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                {/* Priority Card */}
                <div className="bg-primary-50 dark:bg-blue-900/20 rounded-xl p-5 border border-blue-100 dark:border-blue-800 transition-colors">
                    <div className="flex items-start justify-between">
                        <div className="w-full mr-4">
                            <p className="text-sm font-semibold text-blue-500 dark:text-blue-300 mb-1">Priority Level</p>
                            <p className="text-3xl font-bold text-surface-800 dark:text-blue-100">{caseData.priority}/10</p>
                        ...
                        <div className="bg-primary-500 rounded-full p-2.5 shadow-sm mt-1">
                ...
                <div className="bg-emerald-50 dark:bg-green-900/20 rounded-xl p-5 border border-emerald-100 dark:border-green-800 transition-colors">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-surface-800 dark:text-green-100">{documents.length}</p>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-5 border border-purple-100 dark:border-purple-800 transition-colors">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-surface-800 dark:text-purple-100">{notes.length}</p>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-5 border border-orange-100 dark:border-orange-800 transition-colors">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-surface-800 dark:text-orange-100">
                                {daysElapsed}
                            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700 p-6 shadow-sm">
                    <h3 className="text-lg font-semibold text-surface-800 dark:text-white mb-6 flex items-center">
                    ...
                    <div className="h-56 flex items-center justify-center relative">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none mt-[-20px]">
                            <div className="text-center">
                                <span className="text-3xl font-bold text-surface-900 dark:text-white block tracking-tight">{healthMetrics.percentage}%</span>
                                <span className="text-xs font-medium text-surface-500 mt-1">Readiness</span>
                            </div>
                        </div>
                    </div>
                ...
                {/* Timeline Chart */}
                <div className="bg-white dark:bg-surface-800 rounded-xl border border-surface-200 dark:border-surface-700 p-6 shadow-sm flex flex-col">
                    <h3 className="text-lg font-semibold text-surface-800 dark:text-white mb-6 flex items-center">
